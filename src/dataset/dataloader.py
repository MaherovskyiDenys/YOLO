...
from src.dataset.transforms import train_transform, test_transform
...
def get_loaders(
    ...
    train_dataset = VOCDatasetYOLO(base / root, image_set="trainval", transforms=train_transform)
    test_dataset = VOCDatasetYOLO(base / root, image_set="test", transforms=test_transform)
